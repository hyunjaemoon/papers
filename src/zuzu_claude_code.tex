...
Between 2021 and 2026 I ran an experiment, mostly involuntarily, on how much of that structure is actually load-bearing. Moonai (branded in Korean as \emph{Moon-AI}, with \emph{Moon} written in Hangul) is an AI delivery company targeting Korean small and medium-sized businesses, and it has exactly one person: me. Over those five years I attempted to build a portfolio of products, all while holding a full-time engineering perspective shaped by prior industry work: an AI-powered industrial catalog (yushin-melamine.com), a social game-tracking platform (playshelfapp.com), an autonomous Python testing agent (pythontestingagent.com), consumer AI experiences, and the delivery business itself.
