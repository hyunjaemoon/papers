...
Since 2022 I have run an experiment, mostly involuntarily, on how much of that structure is actually load-bearing: three years of platform engineering at Google through 2025, then the solo build of Moonai from 2025 onward. Moonai (branded in Korean as \emph{Moon-AI}, with \emph{Moon} written in Hangul) is an AI delivery company targeting Korean small and medium-sized businesses, and it has exactly one person: me. Building it since 2025, I have attempted to stand up a portfolio of products, drawing on the full-time engineering perspective those Google years produced: an AI-powered industrial catalog (yushin-melamine.com), a social game-tracking platform (playshelfapp.com), an autonomous Python testing agent (pythontestingagent.com), consumer AI experiences, and the delivery business itself.
